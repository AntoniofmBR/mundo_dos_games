function pesquisar() {
  ...
  for (let dado of dados) {
    ...
    if (!campoPesquisa) {
      return alert('Por favor pesquise o nome de um game')
    }
  ...
  if (!resultado) {
    return section.innerHTML = `<p>Parece que o jogo que você está procurando ainda não foi incluído no nosso sistema, por favor digite o nome de outro jogo.</p>
